...
const SendMessageIcon = ({ className, width = '2.6rem', height = '2.6rem' }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
const TickIcon = ({ className, width = '1.4rem', height = '1.4rem' }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export { MessageIcon, UploadIcon, SendMessageIcon, SearchIcon, TickIcon };
